    ...
    <div>
      ...
      <div className="grid grid-cols-6">
        ...
        <div className="col-span-5">
          <h3 className="text-purple-500 text-8xl text-center">Menu</h3>
                    ...
                    return (
                      <>
                        <div className="p-4 lg:w-1/3" key={index}>
                          <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-12 pb-20 rounded-lg overflow-hidden text-center relative">
                            ...
                            <div className="leading-relaxed mb-3">
                              <img src={item.hinhAnh} alt="hình ảnh món ăn" />
                            </div>
                            <a
                            ...
                            <div className="justify-end text-center mt-2 leading-none flex absolute bottom-0 left-0 w-full py-4">
                              <span className="text-gray-400 mr-3 inline-flex items-center leading-none pr-3 py-1 text-lg">
                                Giá: {item.gia}
                              </span>
                            </div>
                          </div>
